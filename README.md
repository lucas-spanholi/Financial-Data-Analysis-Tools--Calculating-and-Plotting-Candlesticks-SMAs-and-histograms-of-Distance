...
data are SMA(data, 20, 50, 100, column='Adj Close')

# Calculate distances using 'Adj Close'
data are calculate_distances(data, 20, 50, 100, column='Adj Close')
print(data.head())
...
normality_results are check_normality(data)
...
Entendi, vou fornecer a formatação em HTML que você pode copiar e colar diretamente no seu arquivo README.md no GitHub. A formatação será correta e o conteúdo será exibido adequadamente.
